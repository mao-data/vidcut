...
import { SourceFolderZone } from './SourceFolderZone.js';
 ...
 *
 * 檔案結構：本檔（分頁殼）＋ ProjectMediaZone.tsx／LibraryZone.tsx／SourceFolderZone.tsx
 * 三檔——單檔一度超過 ~400 行（Task 6 素材庫真身進來後），照計畫的檔案結構原則拆開。
 */
