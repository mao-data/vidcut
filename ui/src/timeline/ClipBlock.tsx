  ...
  return (
    <div
      ...
      style={{
        ...
        background: 'var(--card)',
        // 2026-09-10 使用者定案：主軌 clip 選取改 CapCut 式——2px 外框與左右實心
        // 方塊把手同色（--select-frame：暗房白／紙上 ink），框＋把手讀成一組「框框」。
        // 字幕／overlay chip 仍吃 --select-edge（紅蠟筆），那邊沒改。
        boxShadow: selected
          ? 'inset 0 0 0 2px var(--select-frame), 0 0 14px var(--accent-glow)'
        ...
        ...(floating
          ? {
              ...
              boxShadow: 'var(--shadow-float), inset 0 0 0 2px var(--select-frame)',
            }
          : null),
      }}
    >
