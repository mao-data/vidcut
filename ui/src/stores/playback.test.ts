...
describe('usePlayback', () => {
  ...
  it('Plan 15: setTrimPreview accepts an optional placeholderHead field (TrimPreview from plan.ts)', () => {
    usePlayback.getState().setTrimPreview({ clipId: 'c1', in: 0, placeholderHead: 1.2 });
